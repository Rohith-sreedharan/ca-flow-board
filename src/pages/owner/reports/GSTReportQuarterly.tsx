...
const GSTReportQuarterly = () => {
  ...
  useEffect(() => {
    fetchReport();
  }, [selectedYear, selectedQuarter, page, pageSize, sortBy, sortOrder, filterGstStatus, filterClient, filterReturnType, filterReturnStatus]);
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `gst_report_quarterly_${selectedYear}_${selectedQuarter}.csv`);
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3">
            ...
            GST Quarterly Report
          </h1>
          <p className="text-muted-foreground mt-2">
            View quarterly GST reports with detailed invoice information
          </p>
        </div>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Choose a quarter and financial year to view the report</CardDescription>
            </div>
...
export default GSTReportQuarterly;
